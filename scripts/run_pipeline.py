...
def main(args):
    ...
    os.environ["MLFLOW_ARTIFACT_ROOT"] = os.path.join(project_root, "mlruns")
    ...
    with mlflow.start_run():
        ...
        # mlflow.sklearn.log_model(model,artifact_path="model")  # This creates a 'model/' folder in MLflow run artifacts
